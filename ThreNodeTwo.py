# -*- coding: utf-8 -*-
"""
Created on Mon Sep 11 21:04:45 2017
    ...
    while True:
        ...
        if x == 1:
            ...
            while j<5:
                ...
                fromnodeC['voltage'].insert(j,jason['voltage'][j])
            ...
            while True:
                try:
                    ...
                    while k < 5:
                        ...
                        fromnodeA['voltage'].insert(k,jason['voltage'][k])
                        lock.release()
                        k = k+1 
                        #s.close()
        ...
        if x == 3:
            for i in range(5):
                lock.acquire()
                sumothernode = fromnodeC['voltage'][i]+fromnodeA['voltage'][i]
